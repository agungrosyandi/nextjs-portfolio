    ...
    <>
      <section id="home" className="section-style-home p-5">
        <div className="relative text-stone-800 mt-5 rounded-[20px] tabletMinWidth:mt-10 fullHdMinWidth:px-28">
          <div className="grid grid-cols-2 grid-flow-dense gap-1 py-5 desktopMinWidth:grid-cols-4 desktopMinWidth:grid-rows-1">
            ...
            <div className="bg-stone-200 shadow-xl p-4 my-5 rounded-xl col-span-2 laptopMinWidth:col-span-1 desktopMinWidth:col-span-1 desktopMinWidth:col-start-2 desktopMinWidth:col-end-2 desktopMinWidth:mt-0 desktopMinWidth:mb-4">
              <SkillsSections />
            </div>
            <div className="bg-stone-200 shadow-xl p-4 my-5 rounded-xl col-span-2 laptopMinWidth:col-span-1 desktopMinWidth:col-span-1 desktopMinWidth:col-start-3 desktopMinWidth:col-end-3 desktopMinWidth:mt-0 desktopMinWidth:mb-4">
              <Skills2Sections />
            </div>
