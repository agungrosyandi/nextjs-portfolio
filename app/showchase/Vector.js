...
const Vector = () => {
  return (
    <section id="vector" className="section-without-minheight">
      <div className="relative flex flex-col flex-1 justify-center items-center w-full h-full px-5 pt-10 pb-5 tabletMinWidth:px-10 tabletMinWidth:pb-10 laptopMinWidth:px-20">
        ...
        <div className="grid grid-cols-4 grid-flow-row gap-1 py-5 border-b border-gray-600 tabletMinWidth:py-10">
          <div className="flex-1 col-span-4 lap">
