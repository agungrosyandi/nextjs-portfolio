    ...
    <section id="landingpage" className="section-without-minheight">
      <div className="relative flex flex-col flex-1 justify-center items-center w-full h-full px-5 pt-5 pb-5 tabletMinWidth:px-10 tabletMinWidth:pb-10 tabletMinWidth:pt-10 laptopMinWidth:px-20">
        ...
        <div className="grid grid-cols-2 grid-flow-row gap-1 py-5 border-b border-gray-600 tabletMinWidth:py-10">
          ...
          <div className="flex-1 col-span-2 tabletMinWidth:col-span-1">
        ...
        <div className="relative flex-1">
          ...
          <p
            className={`font-MonaSansUltraLight border-b border-gray-600 text-xs pt-5 pr-5 pb-5 tabletMinWidth:text-base tabletMinWidth:pb-10 laptopMinWidth:text-lg fullHdMinWidth:text-2xl`}
          >
