...
const Landingpage = () => {
  return (
    <section id="landingpage">
      <div className="relative text-stone-800 flex flex-1 flex-col justify-center items-center w-full px-10 pt-20 pb-5 tabletMinWidth:px-10 tabletMinWidth:pt-32 tabletMinWidth:pb-10 laptopMinWidth:px-20 desktopMinWidth:px-32">
